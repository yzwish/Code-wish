...
public class AdminServiceImpl implements AdminService{
	...
	public boolean checkTPass(String list[]) {
        ...
        for(int i = 0;i < list.length; i ++){
        	...
        	if(s==true){
        		String sqlm="insert into message (id,context,time,isRead) values ('"+list[i]+"','个人信息审核通过！欢迎使用本网站！','"+df.format(date)+"','0') ";
        		ConnectionManager.excuteIUD(sqlm,conn,ptmt);
        	}
        }
			ConnectionManager.close(ptmt,rs,conn);
	...
	public boolean checkTNotPass(String list[],String Treason) {
        ...
        for(int i = 0;i < list.length; i ++){
        	...
        	if(s==false) flag=false;
        	if(s==true){
        		String sqlm="insert into message (id,context,time,isRead) values ('"+list[i]+"','个人信息审核未通过！理由："+Treason+"，请修改。','"+df.format(date)+"','0') ";
        		ConnectionManager.excuteIUD(sqlm,conn,ptmt);		
        	}
        }
        ConnectionManager.close(ptmt,rs,conn);
	...
	@Override
	public ArrayList<CheckReport> getReporterStudentInfo() {
		//得到举报用户信息-举报人-学生 
		ArrayList<CheckReport> rerStuL=new ArrayList<CheckReport>();
		Connection conn=ConnectionManager.getInstance().getConnection(); 
		PreparedStatement ptmt=null;
		ResultSet rs=null;
	...
	@Override
	public ArrayList<CheckReport> getReporterTeacherInfo() {
		//得到举报用户信息-举报人-老师
		ArrayList<CheckReport> rerTeaL=new ArrayList<CheckReport>();
		Connection conn=ConnectionManager.getInstance().getConnection(); 
		PreparedStatement ptmt=null;
		ResultSet rs=null;
	...
	@Override
	public ArrayList<CheckReport> getReporterSeniorInfo() {
		//得到举报用户信息-举报人-学长学姐
		ArrayList<CheckReport> rerSenL=new ArrayList<CheckReport>();
		Connection conn=ConnectionManager.getInstance().getConnection(); 
		PreparedStatement ptmt=null;
		ResultSet rs=null;
	...
	@Override
	public ArrayList<CheckReport> getReportedStudentInfo() {
		//得到举报用户信息-被举报人-学生 
		ArrayList<CheckReport> redStuL=new ArrayList<CheckReport>();
		Connection conn=ConnectionManager.getInstance().getConnection(); 
		PreparedStatement ptmt=null;
		ResultSet rs=null;
	...
	@Override
	public ArrayList<CheckReport> getReportedTeacherInfo() {
		//得到举报用户信息-被举报人-老师
		ArrayList<CheckReport> redTeaL=new ArrayList<CheckReport>();
		Connection conn=ConnectionManager.getInstance().getConnection(); 
		PreparedStatement ptmt=null;
		ResultSet rs=null;
	...
	@Override
	public ArrayList<CheckReport> getReportedSeniorInfo() {
		//得到举报用户信息-被举报人-学长学姐
		ArrayList<CheckReport> redSenL=new ArrayList<CheckReport>();
		Connection conn=ConnectionManager.getInstance().getConnection(); 
		PreparedStatement ptmt=null;
		ResultSet rs=null;
	...
	public boolean blockED(String list[], String Bday) {
        ...
        for(int i = 0;i < list.length; i ++){
        	...
        	if(s==true){
        		...
        		//blockedusers表添加数据
        		ConnectionManager.excuteIUD(sqlb,conn,ptmt);
        		...
        		try {
        			while(a.next()){
                		...
                		//向举报用户发送系统通知ConnectionManager.excuteIUD(sqlm2,conn,ptmt);
	...
	@Override
	public ArrayList<CheckTopic> getTopicInfo() {
		//得到话题审核信息
		ArrayList<CheckTopic> tpl=new ArrayList<CheckTopic>();
	...
	@Override
	public ArrayList<CheckReport> getTRerStudentInfo() {
		//得到举报话题信息-举报人-学生 
		ArrayList<CheckReport> TrerStuL=new ArrayList<CheckReport>();
		Connection conn=ConnectionManager.getInstance().getConnection(); 
		PreparedStatement ptmt=null;
		ResultSet rs=null;
	...
	@Override
	public ArrayList<CheckReport> getTRerTeacherInfo() {
		//得到举报话题信息-举报人-老师 
		ArrayList<CheckReport> TrerTeaL=new ArrayList<CheckReport>();
		Connection conn=ConnectionManager.getInstance().getConnection(); 
		PreparedStatement ptmt=null;
		ResultSet rs=null;
	...
	@Override
	public ArrayList<CheckReport> getTRerSeniorInfo() {
		//得到举报话题信息-举报人-学长学姐
		ArrayList<CheckReport> TrerSenL=new ArrayList<CheckReport>();
		Connection conn=ConnectionManager.getInstance().getConnection(); 
		PreparedStatement ptmt=null;
		ResultSet rs=null;
	...
	public ArrayList<CheckReport> getQRerStudentInfo() {
		//得到举报问题信息-举报人-学生 
		ArrayList<CheckReport> QrerStuL=new ArrayList<CheckReport>();
		Connection conn=ConnectionManager.getInstance().getConnection(); 
		PreparedStatement ptmt=null;
		ResultSet rs=null;
	...
	@Override
	public ArrayList<CheckReport> getQRerTeacherInfo() {
		//得到举报问题信息-举报人-老师 
		ArrayList<CheckReport> QrerTeaL=new ArrayList<CheckReport>();
		Connection conn=ConnectionManager.getInstance().getConnection(); 
		PreparedStatement ptmt=null;
		ResultSet rs=null;
	...
	@Override
	public ArrayList<CheckReport> getQRerSeniorInfo() {
		//得到举报话题信息-举报人-学长学姐
		ArrayList<CheckReport> QrerSenL=new ArrayList<CheckReport>();
		Connection conn=ConnectionManager.getInstance().getConnection(); 
		PreparedStatement ptmt=null;
		ResultSet rs=null;
	...
	public ArrayList<CheckReport> getARerStudentInfo() {
		//得到举报回答信息-举报人-学生 
		ArrayList<CheckReport> ArerStuL=new ArrayList<CheckReport>();
		Connection conn=ConnectionManager.getInstance().getConnection(); 
		PreparedStatement ptmt=null;
		ResultSet rs=null;
	...
	@Override
	public ArrayList<CheckReport> getARerTeacherInfo() {
		//得到举报回答信息-举报人-老师 
		ArrayList<CheckReport> ArerTeaL=new ArrayList<CheckReport>();
		Connection conn=ConnectionManager.getInstance().getConnection(); 
		PreparedStatement ptmt=null;
		ResultSet rs=null;
	...
	@Override
	public ArrayList<CheckReport> getARerSeniorInfo() {
		//得到举报回答信息-举报人-学长学姐
		ArrayList<CheckReport> ArerSenL=new ArrayList<CheckReport>();
		Connection conn=ConnectionManager.getInstance().getConnection(); 
		PreparedStatement ptmt=null;
		ResultSet rs=null;
